...
const maru =`\n❍⚯────────────────────⚯❍
               🌐 *𝙻𝙰𝚃𝙴𝚂𝚃 𝚃𝙴𝙲𝙷 𝙽𝙴𝚆𝚂*  🌐
 ⚡ *ᴄʏʙᴇʀ x ᴛᴇᴄʜ ɴᴇᴡꜱ ꜱᴇᴀʀᴄʜ ᴇɴɢɪɴᴇ* ⚡
❍⚯────────────────────⚯❍
...
const vid = await tech.allNews()
 ...
 await conn.sendMessage(from,{image:{url: "https://i.ibb.co/V2yG79P/Banner-Maker-27062023-101137.jpg" },caption: yt + "*ᴄʏʙᴇʀ-x ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ*\n*ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴅᴀʀᴋᴀʟᴘʜᴀxᴛᴇᴀᴍ*" },{quoted:mek })
} catch (e) {
reply('⛔ *Error accurated !!*\n\n' + e )
l(e)
}
