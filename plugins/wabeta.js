...
const vid = await wabetainfo.firstpageposts()
    let yt = '\n❍⚯────────────────────⚯❍\n🥏 *𝚆𝙱𝙸 𝚂𝙴𝚁𝚅𝙸𝙲𝙴 𝙻𝙰𝚃𝙴𝚂𝚃 𝙽𝙴𝚆𝚂 𝙻𝙸𝚂𝚃*  🥏\n      ⚡ *ᴄʏʙᴇʀ x ᴡᴀ ʙᴇᴛᴀ ꜱᴇᴀʀᴄʜ ᴇɴɢɪɴᴇ* ⚡\n❍⚯────────────────────⚯❍\n\n'
    for (let i of vid ) {
        yt += `🥏 *Title - ${i.title} for ${i.platform} - ${i.date}* \n🔗 *Url : ${i.url}*\n📁 *Description : ${i.shortdesc}* \n\n\n\n`
    }
 await conn.sendMessage(from,{image:{url: "https://telegra.ph/file/4cba162e3b2eb338c6934.jpg" },caption: yt + "*ᴄʏʙᴇʀ-x ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀ ʙᴏᴛ*\n*ᴘᴏᴡᴇʀᴇᴅ ʙʏ ᴅᴀʀᴋᴀʟᴘʜᴀxᴛᴇᴀᴍ*" },{quoted:mek })
} catch (e) {
...
*ᴄʏʙᴇʀ-x ᴡʜᴀᴛꜱᴀᴘᴘ  ʙᴏᴛ • ᴠᴏʟ-ɪɪ*
*ᴅᴀʀᴋᴀʟᴘʜᴀxᴛᴇᴀᴍ ᴏꜰꜰɪᴄɪᴀʟ*`
 await conn.sendMessage(from,{image:{url: duka.image },caption: ok },{quoted:mek })
} catch (e) {
reply('⛔ *Error accurated !!*\n\n'+ e)
l(e)
}
